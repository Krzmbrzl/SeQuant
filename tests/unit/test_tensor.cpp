...
TEST_CASE("Tensor", "[elements]") {
  ...
  SECTION("constructors") {
    ...
    REQUIRE_NOTHROW(Tensor(L"N", {L"i_1"}, {}, {L"a_1"}));
    auto t3 = Tensor(L"N", {L"i_1"}, {}, {L"a_1"});
    REQUIRE(t3);
    ...
    REQUIRE_NOTHROW(Tensor(L"g", {Index{L"i_1"}, Index{L"i_2"}},
                           {Index{L"i_3"}, Index{L"i_4"}}, {Index{L"i_5"}},
  ...
  SECTION("hash") {
    ...
    auto t3 = Tensor(L"F", {L"i_2"}, {L"i_1"}, {L"i_3"});
    size_t t3_hash;
  ...
  SECTION("latex") {
    ...
    auto t2 = Tensor(L"F", {L"i_1"}, {L"i_2"}, {L"i_3"});
    REQUIRE(to_latex(t2) == L"{F^{{i_2}}_{{i_1}}({i_3})}");

    auto h1 = ex<Tensor>(L"F", WstrList{L"i_1"}, WstrList{L"i_2"}, WstrList{}) *
