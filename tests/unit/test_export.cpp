  ...
  SECTION("generation_optimizer") {
    ...
    SECTION("elided load/unload") {
      ...
      SECTION("requires caution") {
        export_expression(
            to_export_tree(parse_result_expr(
                L"R{a1,a2;i1,i2} = g{i3,i4;a3,a4} t{a4;i2} t{a1,a3;i1,i4} t{a2;i3} "
...
"Load t[a_4, i_2]\n"
"Compute I[i_3, i_4, i_2, a_3] += g[i_3, i_4, a_3, a_4] t[a_4, i_2]\n"
"Unload t[a_4, i_2]\n"
"Unload g[i_3, i_4, a_3, a_4]\n"
"Load t[a_1, a_3, i_1, i_3]\n"
"Compute I[i_4, a_1, i_1, i_2] += I[i_3, i_4, i_2, a_3] t[a_1, a_3, i_1, i_3]\n"
"Unload t[a_1, a_3, i_1, i_3]\n"
"Unload I[i_3, i_4, i_2, a_3]\n"
"Load t[a_2, i_4]\n"
"Compute R[a_1, a_2, i_1, i_2] += -2 I[i_4, a_1, i_1, i_2] t[a_2, i_4]\n"
"Unload t[a_2, i_4]\n"
...
"Compute I[i_3, a_1, i_1, i_2] += I[i_3, i_4, i_2, a_3] t[a_1, a_3, i_1, i_4]\n"
"Unload t[a_1, a_3, i_1, i_4]\n"
"Unload I[i_3, i_4, i_2, a_3]\n"
"Load t[a_2, i_3]\n"
"Compute R[a_1, a_2, i_1, i_2] += I[i_3, a_1, i_1, i_2] t[a_2, i_3]\n"
"Unload t[a_2, i_3]\n"
...
"Persist R[a_1, a_2, i_1, i_2]\n"
	  ...
	  SECTION("tbd2") {
        export_expression(
            to_export_tree(parse_result_expr(
						L"R1{u_1;i_1;} = "
L"+ 2 g{u_2, i_2;a_1, a_2;} (GAM0{u_3, u_4;u_5, u_2;} T2g{a_2, u_5;u_3, i_2;}) T2g{a_1, u_1;i_1, u_4;} "
"+ -4 g{u_2, i_2;a_1, a_2;} (GAM0{u_3, u_4;u_5, u_2;} T2g{a_1, u_5;i_2, u_3;}) T2g{a_2, u_1;u_4, i_1;} "
)), generator, ctx);
        REQUIRE_THAT(
            generator.get_generated_code(),
            DiffedStringEquals(""));
